...
from agent_runtime import new_runtime, publish_runtime
from backend_commands import configure_agent_registry
from web_server import LocalApiHandler, configure_agent_api
import agent_cli


ROOT = Path(__file__).resolve().parent
PYTHON = shutil.which("python") or sys.executable
CLI_COMMAND = [os.environ["DGUTCTL_TEST_EXE"]] if os.environ.get("DGUTCTL_TEST_EXE") else [PYTHON, str(ROOT / "agent_cli.py")]
