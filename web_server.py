...
from agent_protocol import AgentError, SCHEMA_VERSION, error_response, response
from backend_commands import AGENT_SERVICE, agent_capabilities, backend, configure_agent_registry, handle, handle_agent, update_manager
...
def main() -> None:
    ...
    from browser_launcher import run_background_service
